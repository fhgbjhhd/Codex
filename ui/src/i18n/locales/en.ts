...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    tasks: "Watch n8n workflow runs and per-step bridge status.",
    ...
    config: "Edit openclaw.json safely.",
  ...
  overview: {
    access: {
      ...
      token: "Gateway Token",
      tokenHint:
        "Paste the actual token value here, not a CLI command. Use the desktop CLI tokenized dashboard link if needed.",
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) generated by the desktop CLI on your main machine.",
    },
    insecure: {
