...
run_step "swift build" bash -lc "source '${ROOT_DIR}/scripts/openclaw-swift-env.sh' && openclaw_setup_swift_env '${ROOT_DIR}' && cd '${ROOT_DIR}/apps/macos' && openclaw_swift build -q --product OpenClaw"
